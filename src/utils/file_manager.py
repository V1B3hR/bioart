...
class DNAFileManager:
    ...
    def delete_program(
        self, filename: str, program_type: str = "source", create_backup: bool = True
    ):
        """
            ...
            for _, directory, extension in [
                ...
                if source_path.exists():
                    ...
                    if include_metadata:
                        meta_source = source_path.with_suffix(self.METADATA_EXTENSION)
                        if meta_source.exists():
                            meta_dest = Path(export_path) / (
                                source_path.stem + self.METADATA_EXTENSION
                            )
    ...
    def get_storage_info(self) -> Dict[str, Any]:
        ...
        try:
            info = {"base_directory": str(self.base_directory), "directories": {}}
