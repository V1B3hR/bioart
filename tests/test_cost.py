...
def test_track_operation():
    ...
    op = tracker.track_operation(
        operation_name="encode", duration_seconds=0.5, cost_units=10.0, metadata={"bytes": 1024}
    )
...
def test_set_budget():
    ...
    budget = CostBudget(name="test_budget", max_cost=100.0, warning_threshold_percent=80.0)
...
def test_budget_check_warning():
    ...
    budget = CostBudget(name="test", max_cost=100.0, warning_threshold_percent=80.0)
    tracker.set_budget(budget)
...
def test_budget_check_critical():
    ...
    budget = CostBudget(name="test", max_cost=100.0, critical_threshold_percent=95.0)
    tracker.set_budget(budget)
