...
from biological.error_correction import BiologicalErrorCorrection, ErrorType, ErrorPattern
from biological.synthesis_systems import DNASynthesisManager, SynthesisPlatform, SynthesisStatus
